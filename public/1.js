...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    this.id = this.$route.query.id; //  this.item = this.storage.get('item');
  ...
  methods: {
    ...
    setColorAndItem: function setColorAndItem(id) {
      this.item = this.dataList[id];
      this.color = this.dataList[id].color;
    },
    setAllDates: function setAllDates() {
      var dataList = this.dataList;
      var lastColorType = '';
      var lastYears = '';
      var lastSeries = '';

      for (var val in this.dataList) {
        if (lastColorType != dataList[val].color_type) {
          this.allColorTypes.push({
            value: dataList[val].id,
            label: dataList[val].color_type
          });
        ...
        if (lastSeries != dataList[val].series) {
          this.allSeries.push({
            value: dataList[val].id,
            label: dataList[val].series
          });
          lastSeries = dataList[val].series;
        }
      }
    },
    setByColorType: function setByColorType() {
      var that = this;
    ...
    setByYears: function setByYears() {
      var that = this;
    ...
    setBySeries: function setBySeries() {
      var that = this;
      ...
      _c("div", { staticClass: "page__bd" }, [
        ...
        _c("div", { staticClass: "weui-cells" }, [
          _c("div", { staticClass: "weui-cell" }, [
            ...
            _vm._v(" "),
            _c("div", { staticClass: "weui-cell__ft" }, [
              _vm._v(_vm._s(_vm.item.car_type))
            ])
          ])
        ]),
        _vm._v(" "),
        _c(
          "div",
          { staticClass: "weui-cells", on: { click: _vm.setByYears } },
          [
            _c("div", { staticClass: "weui-cell" }, [
              _vm._m(3),
              _vm._v(" "),
        ...
        _c(
          "div",
          { staticClass: "weui-cells", on: { click: _vm.setBySeries } },
          [
            _c("div", { staticClass: "weui-cell" }, [
              _vm._m(4),
              _vm._v(" "),
        ...
        _c(
          "div",
          { staticClass: "weui-cells", on: { click: _vm.setByColorType } },
          [
            _c("div", { staticClass: "weui-cell" }, [
              _vm._m(7),
              _vm._v(" "),
                    ...
                    return _c("tbody", [
                      _c("tr", [
                        _c("td", { staticClass: "alt" }, [
                          _vm._v(_vm._s(item2.color_master))
                        ]),
                        _vm._v(" "),
                        _c("td", { staticClass: "alt" }, [
                          _vm._v(_vm._s(item2.color_master_name))
                        ]),
                        _vm._v(" "),
                        _c("td", [
                          _vm._v(
                            _vm._s(
                              ((item2.weight / 1000) * _vm.weight).toFixed(3)
                            )
                          )
                        ]),
                        _vm._v(" "),
                        ...
                        _vm._v(" "),
                        _c("td", { staticClass: "alt" }, [
                          _vm._v(_vm._s(item2.component))
                        ]),
                        _vm._v(" "),
                        _c("td", { staticClass: "alt" }, [
                          _vm._v(_vm._s(item2.production))
                        ])
                      ])
                    ])
                  })
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("tr", [
      ...
      _vm._v(" "),
      _c("td", { staticClass: "alt herd" }, [_vm._v("色母名称")]),
      _vm._v(" "),
      _c("td", { staticClass: "alt herd " }, [_vm._v("色母量(g)")]),
      _vm._v(" "),
      _c("td", { staticClass: "alt herd " }, [_vm._v("累积量(g)")]),
      _vm._v(" "),
      _c("td", { staticClass: "alt herd " }, [_vm._v("适用部件")]),
      _vm._v(" "),
      _c("td", { staticClass: "alt herd " }, [_vm._v("工序")])
    ])
  },
  function() {
    var _vm = this
