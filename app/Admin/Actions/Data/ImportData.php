...
class ImportData extends Action
{
    ...
    public function handle()
    {
       ...
       set_time_limit(300);
        try {
            ...
            Excel::import(new ColorExcel(time()), request()->file('file'));
    ...
    public function form()
    {
        ...
        $this->file('file', '请选择文件')->rules('required', ['required' => '文件不能为空']);
    }
    ...
    {
        return <<<HTML
               <a class="btn btn-sm btn-default import-data"><i class="fa fa-upload"></i>&nbsp;&nbsp;导入数据</a>
